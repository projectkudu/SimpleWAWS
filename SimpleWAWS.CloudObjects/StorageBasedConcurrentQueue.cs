...
// =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
//
// StorageBasedConcurrentQueue.cs
//
...
namespace SimpleWAWS.CloudObjects
{
    ...
    /// <remarks>
    /// All public  and protected members of <see cref="StorageBasedConcurrentQueue{T}"/> are thread-safe and may be used
    ...
    [Serializable]
    public class StorageBasedConcurrentQueue<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
    {
        //fields of StorageBasedConcurrentQueue
        [NonSerialized]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageBasedConcurrentQueue{T}"/> class.
        /// </summary>
        public StorageBasedConcurrentQueue()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageBasedConcurrentQueue{T}"/>
        /// class that contains elements copied from the specified collection
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new <see
        /// cref="StorageBasedConcurrentQueue{T}"/>.</param>
        /// <exception cref="T:System.ArgumentNullException">The <paramref name="collection"/> argument is
        /// null.</exception>
        public StorageBasedConcurrentQueue(IEnumerable<T> collection)
        {
            if (collection == null)
            {
        ...
        /// with the SyncRoot; otherwise, false. For <see cref="StorageBasedConcurrentQueue{T}"/>, this property always
        /// returns false.</value>
        ...
        /// <remarks>For <see cref="StorageBasedConcurrentQueue{T}"/>, this operation will always add the object to the
        /// end of the <see cref="StorageBasedConcurrentQueue{T}"/>
        ...
        /// <remarks>For <see cref="StorageBasedConcurrentQueue{T}"/>, this operation will attempt to remove the object
        /// from the beginning of the <see cref="StorageBasedConcurrentQueue{T}"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Gets a value that indicates whether the <see cref="StorageBasedConcurrentQueue{T}"/> is empty.
        /// </summary>
        /// <value>true if the <see cref="StorageBasedConcurrentQueue{T}"/> is empty; otherwise, false.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Copies the elements stored in the <see cref="StorageBasedConcurrentQueue{T}"/> to a new array.
        /// </summary>
        /// <returns>A new array containing a snapshot of elements copied from the <see
        /// cref="StorageBasedConcurrentQueue{T}"/>.</returns>
        public T[] ToArray()
        {
        ...
        /// <summary>
        /// Copies the <see cref="StorageBasedConcurrentQueue{T}"/> elements to a new <see
        /// cref="T:System.Collections.Generic.List{T}"/>.
        /// </summary>
        /// <returns>A new <see cref="T:System.Collections.Generic.List{T}"/> containing a snapshot of
        /// elements copied from the <see cref="StorageBasedConcurrentQueue{T}"/>.</returns>
        ...
        /// <summary>
        /// Gets the number of elements contained in the <see cref="StorageBasedConcurrentQueue{T}"/>.
        /// </summary>
        /// <value>The number of elements contained in the <see cref="StorageBasedConcurrentQueue{T}"/>.</value>
        /// <remarks>
        ...
        /// <summary>
        /// Copies the <see cref="StorageBasedConcurrentQueue{T}"/> elements to an existing one-dimensional <see
        /// cref="T:System.Array">Array</see>, starting at the specified array index.
        /// </summary>
        /// <param name="array">The one-dimensional <see cref="T:System.Array">Array</see> that is the
        /// destination of the elements copied from the
        /// <see cref="StorageBasedConcurrentQueue{T}"/>. The <see cref="T:System.Array">Array</see> must have zero-based
        /// indexing.</param>
        /// <param name="index">The zero-based index in <paramref name="array"/> at which copying
        /// begins.</param>
        /// <exception cref="ArgumentNullException"><paramref name="array"/> is a null reference (Nothing in
        ...
        /// -or- The number of elements in the source <see cref="StorageBasedConcurrentQueue{T}"/> is greater than the
        ...
        /// cref="StorageBasedConcurrentQueue{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds an object to the end of the <see cref="StorageBasedConcurrentQueue{T}"/>.
        /// </summary>
        /// <param name="item">The object to add to the end of the <see
        /// cref="StorageBasedConcurrentQueue{T}"/>. The value can be a null reference
        ...
        /// <summary>
        /// Attempts to return an object from the beginning of the <see cref="StorageBasedConcurrentQueue{T}"/>
        /// without removing it.
        /// </summary>
        ...
        /// <summary>
        /// private class for StorageBasedConcurrentQueue. 
        ...
        private class Segment
        {
            ...
            private volatile StorageBasedConcurrentQueue<T> m_source;

            /// <summary>
            /// Create and initialize a segment with the specified index.
            /// </summary>
            internal Segment(long index, StorageBasedConcurrentQueue<T> source)
            {
            ...
            /// exclusively called by StorageBasedConcurrentQueue.InitializedFromCollection
