...
namespace SimpleWAWS
{
    public class SimpleWawsService : System.Web.HttpApplication
    {
        ...
        protected void Application_Start()
        {
            ...
            RouteTable.Routes.MapHttpRoute("get-vscode-resource", "api/vscoderesource", new { controller = "Resource", action = "GetVSCodeResource", authenticated = false}, new { verb = new HttpMethodConstraint("GET") });
            ...
            RouteTable.Routes.MapHttpRoute("get-app-vscode-url", "api/resource/vscodeurl", new { controller = "Resource", action = "GetVSCodeUrl", authenticated = true }, new { verb = new HttpMethodConstraint("GET") });
