...
namespace SimpleWAWS
{
    class SiteNameGenerator
    {
        private string[] _adjectives = new string[] { "Blue", "Green", "Orange", "Pink", "Purple", "Red", "Yellow", "Adventurous", "Bold", "Brave", "Bright", "Charming", "Cool", "Courageous",
            "Creative", "Dazzling", "Dancing", "Eager", "Fast", "Fearless", "Friendly", "Heroic", "Important", "Impressive", "Ingenious", "Insightful", "Intuitive", "Laughing", "Masterful",
            "Mighty", "Modern", "Outstanding", "Smooth", "Patient", "Peaceful", "Popular", "Precise", "Productive", "Proud", "Resilient", "Resourceful", "Running", "Savvy", "Sociable",
            "Sharp", "Shiny", "Skillful", "Speedy", "Spirited", "Strong", "Stunning", "Successful", "Talented", "Technical", "Tenacious", "Upbeat", "Valuable", "Victorious",
