    ...
    <script type="text/javascript">
        ...
        var reCaptchaCallback = function (response) {
            if (response !== '') {
                ...
                setTimeout(function () {
                    window.location.href = "<%Environment.GetEnvironmentVariable("ReCaptchaEndpoint").Replace("/recaptcha", String.Empty);%>/?code=" + response + "&state=" + encodeURI(urlParams["state"]);
                }, 1000);
